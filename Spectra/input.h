...
/* File names */
#define OUTPUT_PREFIX "OUT/Spec_0_UPS-LOW-G-CLEARY-250_phase_0.0_inc_1.1520.00.0"      /* output name */
#define T_P_3D_FILE "DATA/Final_UPS-LOW-G-CLEARY-250_phase_0.0_inc_1.152.txt"         /* input file */
